...
/* 校验一个槽: 从 base 起 size 字节的 CRC 是否等于 crc; 0=完好, -1=非法/CRC不符 */
...
/* 把备份槽K的旧app回滚到运行槽R, 成功则更新config里R的信息 */
